...
describe('ReviewEngine', () => {
  ...
  it('should detect forbidden licenses', async () => {
    ...
    assert.strictEqual(results.invalidLicenseChanges.forbidden[0].license, 'GPL-3.0')
  })
  ...
  it('should detect unlicensed packages', async () => {
    ...
    assert.strictEqual(results.invalidLicenseChanges.unlicensed[0].name, 'test-package')
  })
