...
/**
 * A class that fetches the scorecard levels for a given set of changes
 */
export class ScorecardService {
	...
	/**
	 * Get the scorecard levels for a given set of changes
	 * @param changes - The changes to get the scorecard levels for
	 * @returns The scorecard levels
	 */
	async getScorecardLevels(
	 ...
	 * @returns The scorecard entries
	 */
	private async processChunk(
		changes: DependencyChange[],
	): Promise<ScorecardEntry[]> {
		return Promise.all(
			changes.map((change) => this.getScorecardWithCache(change)),
		);
	}

	/**
	 * Get the scorecard with cache for a given change
	 * @param change - The change to get the scorecard with cache for
	 * @returns The scorecard entry
	 */
	private async getScorecardWithCache(
	...
	/**
	 * Fetch the scorecard for a given repository URL
	 * @param repositoryUrl - The repository URL to fetch the scorecard for
	 * @returns The scorecard response
	 */
	private async fetchScorecard(
...
/**
 * Get the scorecard for a given repository URL
 * @param repositoryUrl - The repository URL to get the scorecard for
 * @returns The scorecard response
 */
...
/**
 * Get the project URL for a given package name and version
